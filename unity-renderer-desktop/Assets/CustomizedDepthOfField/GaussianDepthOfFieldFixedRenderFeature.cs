...
{
    [ExcludeFromPreset]
    public class GaussianDepthOfFieldFixedRenderFeature : ScriptableRendererFeature
    {
        private GaussianDepthOfFieldFixedRenderPass renderPass;
        ...
        public override void Create()
        {
            ...
            destinationTexture.Init("_GaussianDepthMap");
            renderPass = new GaussianDepthOfFieldFixedRenderPass(settings.@event,
